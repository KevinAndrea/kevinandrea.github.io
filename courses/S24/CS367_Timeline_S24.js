...
//    dataTable.addColumn({ type: 'string', role: 'tooltip' });
    ...
    dataTable.addRows([
      ...
      // Finals
      [ 'Exams-001', 'Final-001',         doDate(2024,5,1,13,30),   doDate(2024,5,1,16,15) ],
      [ 'Exams-002', 'Final-002',         doDate(2024,5,6,13,30),  doDate(2024,5,6,16,15) ],
      [ 'Exams-003', 'Final-003',         doDate(2024,5,7,10,30),  doDate(2024,5,7,13,15) ],
      [ 'Exams-004', 'Final-004',         doDate(2024,5,2,7,30),  doDate(2024,5,2,10,15) ],
      // Midterms
      [ 'Exams-001', 'Midterm-001',       doDate(2024,2,26,13,30),    doDate(2024,2,26,14,45) ],
      [ 'Exams-002', 'Midterm-002',       doDate(2024,2,26,15,00),    doDate(2024,2,26,16,15) ],
      [ 'Exams-003', 'Midterm-003',       doDate(2024,2,27,10,30),  doDate(2024,2,27,11,45) ],
      [ 'Exams-004', 'Midterm-004',       doDate(2024,2,27,9,00),  doDate(2024,2,27,10,15) ],
      // Projects
      [ 'Projects', 'Project 1',          doDate(2024,1,18,18,0),   doDate(2024,2,2,23,59) ],
      [ 'Projects', 'Project 2',          doDate(2024,2,7,19,0),   doDate(2024,3,1,23,59) ],
      [ 'Projects', 'Project 3',          doDate(2024,3,4,18,0),   doDate(2024,4,5,23,59) ],
      [ 'Projects', 'Project 4',          doDate(2024,4,9,18,0),  doDate(2024,4,26,23,59) ],
      // Quizzes
      [ 'Quizzes',  '1',                  doDate(2024,1,23,6,0),    doDate(2024,1,25,23,59) ],
      [ 'Quizzes',  '2',                  doDate(2024,1,30,6,0),    doDate(2024,2,1,23,59) ],
      [ 'Quizzes',  '3',                  doDate(2024,2,6,6,0),     doDate(2024,2,8,23,59) ],
      [ 'Quizzes',  '4',                  doDate(2024,2,13,6,0),    doDate(2024,2,15,23,59) ],
      [ 'Quizzes',  '5',                  doDate(2024,2,20,6,0),    doDate(2024,2,22,23,59) ],
      [ 'Quizzes',  '6',                  doDate(2024,2,23,6,0),    doDate(2024,2,24,23,59) ],
      [ 'Quizzes',  '7',                  doDate(2024,3,12,6,0),    doDate(2024,3,14,23,59) ],
      [ 'Quizzes',  '8',                  doDate(2024,3,19,18,0),   doDate(2024,3,21,23,59) ],
      [ 'Quizzes',  '9',                  doDate(2024,3,26,6,0),    doDate(2024,3,28,23,59) ],
      [ 'Quizzes',  '10',                 doDate(2024,4,2,6,0),     doDate(2024,4,4,23,59) ],
      [ 'Quizzes',  '11',                 doDate(2024,4,9,6,0),     doDate(2024,4,11,23,59) ],
      [ 'Quizzes',  '12',                 doDate(2024,4,16,6,0),    doDate(2024,4,18,23,59) ],
      [ 'Quizzes',  '13',                 doDate(2024,4,23,6,0),    doDate(2024,4,25,23,59) ],
      [ 'Quizzes',  '14',                 doDate(2024,4,26,18,0),   doDate(2024,4,28,23,59) ],
      // Recitations
      [ 'Recitations',  '1',              doDate(2024,1,19,9,30),   doDate(2024,1,19,16,20) ],
      [ 'Recitations',  '2',              doDate(2024,1,26,9,30),   doDate(2024,1,26,16,20) ],
      [ 'Recitations',  '3',              doDate(2024,2,2,9,30),    doDate(2024,2,2,16,20) ],
      [ 'Recitations',  '4',              doDate(2024,2,9,9,30),    doDate(2024,2,9,16,20) ],
      [ 'Recitations',  '5',              doDate(2024,2,16,9,30),   doDate(2024,2,16,16,20) ],
      [ 'Recitations',  '6',              doDate(2024,2,23,9,30),   doDate(2024,2,23,16,20) ],
      [ 'Recitations',  '7',              doDate(2024,3,1,9,30),    doDate(2024,3,1,16,20) ],
      [ 'Recitations',  '8',              doDate(2024,3,15,9,30),   doDate(2024,3,15,16,20) ],
      [ 'Recitations',  '9',              doDate(2024,3,22,9,30),   doDate(2024,3,22,16,20) ],
      [ 'Recitations',  '10',             doDate(2024,3,29,9,30),   doDate(2024,3,29,16,20) ],
      [ 'Recitations',  '11',             doDate(2024,4,5,9,30),    doDate(2024,4,5,16,20) ],
      [ 'Recitations',  '12',             doDate(2024,4,12,9,30),   doDate(2024,4,12,16,20) ],
      [ 'Recitations',  '13',             doDate(2024,4,19,9,30),   doDate(2024,4,19,16,20) ],
      [ 'Recitations',  '14',             doDate(2024,4,26,9,30),   doDate(2024,4,26,16,20) ],
